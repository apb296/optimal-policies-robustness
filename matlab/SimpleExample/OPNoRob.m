...
obj.Gamma_lambda_lambda=ones(obj.N,1);  
 ...
 for s=1:obj.N 
        ...
        obj.Gamma_lambda_lambda=-obj.Gamma_pi_lambda*(obj.alpha_p_pi+obj.mu_0*obj.alpha_a_pi)+1;
        ...
        function error=error_in_pc(obj,s,lambda_tilde_today)
            mu_today=obj.mu_0;
            
            for s_star=1:obj.N
                
                pi_star(s_star)=obj.pi{s_star}(obj.lambda_tilde{s}(lambda_tilde_today));                                
            end
            ...
            E_pi_star=sum(obj.PI(s,:).*pi_star);
            ...
            error=obj.pi{s}(lambda_tilde_today)-pi_coeff^(-1).*(other_stuff_in_rhs+obj.beta*E_pi_star);
